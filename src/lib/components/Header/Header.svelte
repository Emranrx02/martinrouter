<section class="flex md:flex-row flex-col px-10 justify-center">
	...
	/>
	<div
		class="flex w-full flex-col pb-16 md:py-0 order-1 md:order-2 items-center md:items-end gap-40"
	>
		<h1 class="uppercase mt-28 font-bold text-5xl md:text-3xl lg:text-5xl">MEET martinRouter</h1>
		<button
