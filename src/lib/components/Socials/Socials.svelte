...
<ContentLayout>
 <div id="socials" class="flex md:flex-row flex-col px-7 gap-10 pt-48">
    <div class="">
        <img class="h-[40rem] animate-pulse delay-700" src="/router3.png" alt="router 3"/>
    </div>
    <section class="text-right">
      <h3 class="text-3xl sm:text-5xl font-medium mb-7">All you can eat is Treat</h3>
      <p class=" text-xl sm:text-2xl">Don't miss out on the joy of owning plenty of $MARTIN tokens {"–"} it's like discovering the perfect router treat on Solana.</p>
